...
export default function handler(req: VercelRequest, res: VercelResponse) {
  ...
  let description =
    'Instantly locate verified hospitals, clinics, doctors, and healthcare services near you.'
  ...
  // === Other Pages ===
    ...
    description =
      'Get daily actionable wellness tips for better physical and mental health.'
    ...
    description =
      'Real-time disease outbreak alerts and safety protocols worldwide.'
    ...
    description =
      'Latest global health news, medical research, breakthroughs, and healthcare innovations.'
    image = 'https://hospitofind.online/og-news.jpg'
  } else if (url.includes('/about')) {
    title = 'Our Mission | Making Healthcare Accessible Worldwide'
    description =
      'Making global healthcare accessible, transparent, and verified for everyone.'
    ...
    description =
      'Browse verified hospitals and healthcare facilities worldwide.'
