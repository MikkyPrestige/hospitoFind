...
import { getUniqueCities } from "@/components/utils/helper"
...
//     // Background Sync (Send to MongoDB)
//     if (state.accessToken) {
//       syncFavorite(h._id);
//     }
//   };
...
//     // Background Sync
//     if (state.accessToken) {
//       const res = await syncView(hospital._id);
//       // Update with exact server count if needed
//       if (res?.data?.weeklyViews) onWeeklyViewsChange?.(res.data.weeklyViews);
//     }
//   };
