...
export const features = [
  {
    ...
    text: 'Access detailed facility records, including specialized services, accreditation status, and direct contact channels.',
  },
  {
    icon: <FaMapMarkedAlt />,
    title: 'Interactive Mapping',
    text: 'Visualize healthcare density in your region with our precision mapping tools and get instant turn-by-turn directions.',
  },
  {
    icon: <BsGlobe2 />,
    title: 'Global Directory',
    text: 'Seamlessly switch between countries to find care while traveling or for family members abroad.',
  },
  {
    icon: <MdOutlineManageSearch />,
    title: 'Agent Intelligence',
    text: 'Utilize our intelligent routing agent to navigate healthcare networks and find the most suitable, verified facilities tailored to your specific needs.',
  },
]
...
export const steps = [
  {
    img: Search,
    head: 'Search & Discover',
    text: 'Enter your city or region to instantly view a curated list of verified medical facilities near you.',
    pos: 'content1',
  },
  {
    img: Stethoscope,
    head: 'Create Profile',
    text: 'Sign up to save critical contacts, track your history, and unlock advanced search filters.',
    pos: 'content2',
  },
  {
    img: Handset,
    head: 'Save & Share',
    text: 'Export facility details to PDF or share secure links with family members in emergencies.',
    pos: 'content3',
  },
  {
    img: Laptop,
    head: 'Contribute Data',
    text: 'Help the community by submitting new facilities or updating existing records for verification.',
    pos: 'content4',
  },
]
