...
const HospitalDetails = () => {
  ...
  const { hospital, loading, error, retry, isFavorite, toggleFavorite } =
    useHospitalDetails({
      id,
      country,
      city,
    ...
    return (
      <div className={style.errorContainer}>
        <div className={style.errorCard}>
          ...
          <button onClick={retry} className={style.errorBtn}>
            Try Again
          </button>
        </div>
      </div>
        ...
        <div className={style.errorContainer}>
          <div className={style.errorCard}>
            ...
            <p className={style.errorText}>
              The healthcare facility you requested cannot be found. It may have
            ...
            <div className={style.printHeader}>
              <div className={style.printBranding}>
                <img
                  ...
                  className={style.printLogo}
                />
                <div>
                  <h2 className={style.printTitle}>HospitoFind</h2>
                  <p className={style.printSubtitle}>
              ...
              <div className={style.printMeta}>
                ...
                <p>
                  <strong>Source:</strong> hospitofind.online
                </p>
              </div>
            </div>
                  ...
                  <div className={style.headerMain}>
                    <div className={style.titleBlock}>
                      <div className={style.badgeRow}>
                        ...
                        {hospital.type && (
                          <span
                            className={`${style.typeBadge} ${hospital.type.toLowerCase() === 'private' ? style.privateBadge : style.publicBadge}`}
                          >
                            {hospital.type}
                          </span>
                        )}
                    ...
                    <div className={style.actionButtons}>
                      <button
                        ...
                        className={`${style.actionBtn} ${isFavorite ? style.isFav : ''}`}
                      >
                        {isFavorite ? (
                          <AiFillHeart size={20} />
                        ) : (
                      ...
                      <div className={style.contactItem}>
                        ...
                        <div className={style.contactContent}>
                          ...
                          <a
                            ...
                            className={style.infoLink}
                          >
                            Visit Website <FaArrowRight size={20} />
                          </a>
                        </div>
                      </div>
                    )}
                  ...
                  {hospital.services && hospital.services.length > 0 && (
                    <div className={style.servicesSection}>
                      <h3 className={style.sectionTitle}>
                        <MdLocalHospital /> Specialties & Services
                      </h3>
                  ...
                  {hospital.comments && hospital.comments.length > 0 && (
                    <div className={style.commentsSection}>
                      <h3 className={style.commentsTitle}>
                        <MdInfoOutline /> Facility Information
                      </h3>
              ...
              <aside className={style.sidebarColumn}>
                ...
                {hospital.hours && hospital.hours.length > 0 && (
                  <div className={style.sidebarCard}>
                    <div className={style.cardHeader}>
                      <h3>
                        <MdAccessTime /> Operating Hours
                      </h3>
                    </div>
                    <ul className={style.hoursList}>
                      {hospital.hours.map((hour: Hours, i: number) => (
                        <li key={i}>
