    ...
    >
      <div className={style.contentHeader}>
        ...
        <h3 className={style.trustedTitle}>
          ...
          <span className={style.accent}>Medical Institutions</span>
        </h3>
        <p className={style.subText}>
          We collaborate with accredited hospitals worldwide to ensure you
          receive verified, high-quality care wherever you are.
        </p>
      </div>
