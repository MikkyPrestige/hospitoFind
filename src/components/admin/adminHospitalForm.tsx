...
import { standardizeText } from "../utils/helper";
...
//             name: standardizeText(formData.name),
//             type: standardizeText(formData.type),
//             street: standardizeText(formData.street || formData.address?.street),
//             city: standardizeText(formData.city || formData.address?.city),
//             state: standardizeText(formData.state || formData.address?.state),
//             email: formData.email?.toLowerCase().trim() || "",
//             website: formData.website?.toLowerCase().trim() || "",
...
//         try {
//             const { data } = await axiosPrivate.get(
//                 `/admin/hospitals/check-duplicate?name=${formData.name}&city=${formData.city}&currentId=${formData._id}`
//             );

//             if (data.isDuplicate) {
//                 toast.error(data.message, { icon: <FiAlertTriangle /> });
//             } else {
//                 toast.success("No duplicates found.", { icon: <FiCheck /> });
//             }
//         } catch (err) {
...
//             <div className={styles.photoPreviewSection}>
//                 <label className={styles.sectionLabel}><FiImage /> Photo Preview</label>
//                 <div className={styles.previewContainer}>
//                     {formData.photoUrl ? (
//                         <img
//                             src={formData.photoUrl}
...
//             <div className={styles.formSection}>
//                 <label className={styles.sectionLabel}><FiActivity /> General Information</label>
//                 <div className={styles.inputWithAction}>
//                     <input
//                         type="text"
...
//                 <div className={styles.formRow}>
//                     <div className={styles.inputGroup}>
//                         <input type="text" placeholder="Hospital Name *" required value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} />
//                     </div>
//                     <div className={styles.inputGroup}>
//                         <input type="text" placeholder="Type (e.g. Private)" value={formData.type} onChange={e => setFormData({ ...formData, type: e.target.value })} />
//                     </div>
//                 </div>
//             </div>

//             <div className={styles.formSection}>
//                 <label className={styles.sectionLabel}><FiMapPin /> Location Details</label>
//                 <div className={styles.inputGroup}>
//                     <input type="text" placeholder="Street Address" value={formData.street} onChange={e => setFormData({ ...formData, street: e.target.value })} />
//                 </div>
//                 <div className={styles.formRow}>
//                     <div className={styles.inputGroup}>
...
//             <div className={styles.formSection}>
//                 <label className={styles.sectionLabel}><FiImage /> Contact & Media</label>
//                 <div className={styles.formRow}>
//                     <div className={styles.inputGroup}>
//                         <input type="tel" placeholder="Phone Number" value={formData.phoneNumber} onChange={e => setFormData({ ...formData, phoneNumber: e.target.value })} />
//                     </div>
...
//                 <div className={styles.formRow}>
//                     <div className={styles.inputGroup}>
//                         <input type="text" placeholder="Website URL (e.g. www.hospital.com)" value={formData.website} onChange={e => setFormData({ ...formData, website: e.target.value })} />
//                     </div>
//                     <div className={styles.inputGroup}>
//                         <input type="url" placeholder="Photo URL" value={formData.photoUrl} onChange={e => setFormData({ ...formData, photoUrl: e.target.value })} />
//                     </div>
//                 </div>
//             </div>

//             <div className={styles.formSection}>
//                 <label className={styles.sectionLabel}><FiClock /> Services</label>
//                 <div className={styles.inputGroup}>
//                     <textarea
//                         placeholder="Services (comma separated: Cardiology, Pharmacy, Surgery...)"
...
//             <div className={styles.formSection}>
//                 <label className={styles.sectionLabel}><FiMessageSquare />Comments</label>
//                 <textarea
//                     placeholder="Enter notes or review user comments here..."
//                     className={styles.commentArea}
//                     value={formData.comments ? formData.comments.join("\n") : ""}
//                     onChange={e => setFormData({ ...formData, comments: e.target.value.split("\n") })}
//                 />
//             </div>
...
//                             <input
//                                 type="text"
//                                 placeholder="e.g. 08:00 - 18:00 or 24 Hours"
//                                 value={hour.open}
//                                 onChange={(e) => updateHourRow(index, 'open', e.target.value)}
//                             />
//                             <button type="button" onClick={() => removeHourRow(index)} className={styles.removeBtn}>
...
//                     ))}
//                     {(!formData.hours || formData.hours.length === 0) && (
//                         <p className={styles.emptyNote}>No hours added yet. Click 'Add Day' to specify timing.</p>
//                     )}
//                 </div>
//             </div>
...
//                         onChange={e => setFormData({ ...formData, verified: e.target.checked })}
//                     />
//                     <span>Verified (Visible on Public Site)</span>
//                 </label>
...
//             <button type="submit" disabled={loading} className={styles.submitBtn}>
//                 <FiSave /> {loading ? "Processing..." : "Save Entry"}
//             </button>
//         </form>
//     );
// };
