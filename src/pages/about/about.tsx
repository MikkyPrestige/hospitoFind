...
const About = () => {
  const { totalHospitals, totalCountries, loading, error, retry } =
    useGlobalStats()
  ...
  return (
    <>
      ...
      <main className={style.bg}>
        <Motion className={style.heroWrapper} variants={fadeUp} as="section">
          <div className={style.heroContent}>
            ...
            <h1 className={style.heroTitle}>
              Connecting You to{' '}
              <span className={style.span}>Verified Global Healthcare</span>
            </h1>
            <p className={style.heroPara}>
              In a medical emergency, accurate information saves lives.
              HospitoFind is the world's most reliable directory for verified
              hospitals, clinics, and emergency centers. We bridge the gap
              between patients and quality care through technology and
              transparency.
            </p>
          ...
          <div className={style.heroImages}>
            <motion.div variants={slideLeft} className={style.img1}>
              <Avatar
                image={PhoneMap}
                alt="HospitoFind Mobile Interface"
        ...
        <Motion
          className={style.missionWrapper}
        ...
        >
          <div className={style.missionGrid}>
            <div className={style.missionText}>
              ...
              <p>
                To democratize healthcare access by providing a centralized,
                verified source of medical facility data. We envision a world
                where finding safe, reliable medical care is immediate and
                stress-free, regardless of your location, language, or
                circumstance.
              </p>
            </div>
            <div className={style.valuesList}>
              <div className={style.valueItem}>
                ...
                <div className={style.valueContent}>
                  ...
                  <p>
                    We rigorously verify every facility to ensure you have
                    accurate contact details and location data when it matters
                    most.
                  </p>
                </div>
              </div>
              <div className={style.valueItem}>
                ...
                <div className={style.valueContent}>
                  <h4>Rapid Access</h4>
                  <p>
                    Our platform is optimized for speed, delivering critical
                    information instantly, even in low-bandwidth environments.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className={style.featureSection}>
          <div className={style.sectionHeaderCenter}>
            <h2>
              Why Choose <span>HospitoFind</span>?
            </h2>
        ...
        <Motion
          className={style.howItWorksWrapper}
          variants={sectionReveal}
          as="section"
        >
          <div className={style.howItWorks_inner}>
            <div className={style.sectionHeaderCenter}>
              ...
              <p className={style.subHeading}>
                Four simple steps to accessing or contributing to our global
                network.
              </p>
            </div>
        ...
        >
          <div className={style.reviewHeader}>
            ...
            <p className={style.review_subtitle}>
              See how HospitoFind is making a difference in communities
              worldwide.
            </p>
          </div>
