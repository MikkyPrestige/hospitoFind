  ...
  return (
    <div className={style.home}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="hospital, doctor, appointment, health, care, medical, clinic, find, search, nearby, nearest"
        />
      </Helmet>
      <Header />
          ...
          <div className={style.container}>
            <div className={style.header}>
              <h1 className={style.title}>
                Find the nearest hospital to you in Nigeria
              </h1>
          ...
          <div className={style.img}>
            <Avatar
              ...
              style={{
                ...
                boxShadow:
                  '12px 12px 20px 0px rgba(14, 61, 183, 0.25), 0px 4px 4px 0px rgba(0, 0, 0, 0.25)',
                objectFit: 'cover',
              }}
            />
          </div>
